...
function fngl_s_core_enqueue_editor_styles() {
	wp_enqueue_style( 
        // 'fngl_s-core', get_theme_file_uri( 'editor.css' ), array(), wp_get_theme()->get( 'Version' ), 'all' );
        'fngl_s-core', get_theme_file_uri( 'editor.css' ), null, wp_get_theme()->get( 'Version' ), 'all' );
}
