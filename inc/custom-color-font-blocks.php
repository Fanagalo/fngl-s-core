...
if ( ! function_exists( 'fngl_s_core_color_font_blocks' ) ) :
    function fngl_s_core_color_font_blocks() {
		...
		// customized color palette */
            ...
            array('name' => __( 'dark blue',  'fngl_s-core' ), 'slug' => 'fngl-dark-blue',  'color' => 'var(--fngl-dark-blue)',),
            array('name' => __( 'light blue', 'fngl_s-core' ), 'slug' => 'fngl-light-blue', 'color' => 'var(--fngl-light-blue)',),
            array('name' => __( 'purple',     'fngl_s-core' ), 'slug' => 'fngl-purple',     'color' => 'var(--fngl-purple)',),
            array('name' => __( 'magenta',    'fngl_s-core' ), 'slug' => 'fngl-magenta',    'color' => 'var(--fngl-magenta)',),
            array('name' => __( 'dark red',   'fngl_s-core' ), 'slug' => 'fngl-dark-red',   'color' => 'var(--fngl-dark-red)',),
            array('name' => __( 'red',        'fngl_s-core' ), 'slug' => 'fngl-red',        'color' => 'var(--fngl-red)',),
            array('name' => __( 'yellow',     'fngl_s-core' ), 'slug' => 'fngl-yellow',     'color' => 'var(--fngl-yellow)',),
        ) );
        ...
        /*    array(
                'name'     => esc_attr__( 'Fanagalo gradient', 'fngl_s-core' ),
